...
class Commandes
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Restaurants::class, inversedBy="commandes",cascade={"persist"})
    ...
    public function getTableResto(): ?int
    {
        return $this->tableResto;
    }

    public function setTableResto(int $tableResto): self
    {
