...
/**
     * @Route("/commandes/{commande<[0-9]+>}", name="app_commande_servi")
     */
    public function Servi(RestaurantsRepository $repo, Commandes $commande): Response
    {
