...

{
     ...
     */
    public function index(EntityManagerInterface $em, RestaurantsRepository $repo,Restaurants $restaurant,TablesRepository $tableRepo,Tables $table,Request $request): Response
    {   
            $session=$request->getSession();
            $session->set('tabl',$table->getId());
