...
class RestaurantController extends AbstractController
{
    ...
    /**
     * @Route("/restaurant/{id<[0-9]+>}", name="app_edit_restaurant", methods={"POST","GET"})
     */
     ...
     * delete
     *
     * @Route("/restaurant/{id<[0-9]+>/delete}", name="app_delete_restaurant" ,methods="DELETE")  // {id<[0-9]+>} signifie que le id doit etre un nombre
     */
