...

{
     ...
     */
    public function editPlat(EntityManagerInterface $em,Request $request,PlatMenu $plat, Restaurants $restaurant, PlatMenuRepository $repo, CategoriesMenu $categorie,CategoriesMenuRepository $categorieMenu): Response
    {
