...

{
    ...
    /**
     * @Route("/plat/menu/restaurant/{restaurant}{slug}/categorie/{categorie}/menu", name="plats_menu")
     */
    public function index(Request $request, Restaurants $restaurant, PlatMenuRepository $repo, CategoriesMenu $categorie,CategoriesMenuRepository $categorieMenu,$slug): Response
    {
