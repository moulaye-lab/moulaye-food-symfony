...

{
     ...
     */
    public function index(Request $request, PlatMenuRepository $plat, Restaurants $restaurant,CategoriesMenu $categorie,CategoriesMenuRepository $categorieMenu,EntityManagerInterface $em): Response
    {
