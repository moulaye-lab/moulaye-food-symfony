...

{
     ...
     */
    public function index(Request $request, Restaurants $restaurant,CategoriesMenu $categorie,CategoriesMenuRepository $categorieMenu,EntityManagerInterface $em): Response
    {
       ...
       $form=$this->createForm(AddPlatMenuType::class,$plat);
