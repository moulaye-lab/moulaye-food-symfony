            ...
            for ($i=1; $i<= $tablesAjouter ; $i++) { 
                ...
                $Ntable= $tables->getNumero();
                 ...
                 $qrCode->setForegroundColor(['r' => 0, 'g' => 0, 'b' => 0, 'a' => 0]);
                    ...
                    $qrCode->writeFile(__DIR__."%kernel.project_dir%/public/codeqr/$Ntable.png");
                ...
                $em->flush();
                 ...
                 $qrCode->setForegroundColor(['r' => 0, 'g' => 0, 'b' => 0, 'a' => 0]);
                    $qrCode->setBackgroundColor(['r' => 255, 'g' => 255, 'b' => 255, 'a' => 0]);
                    $qrCode->setLabel('Scan the code');
                    $qrCode->writeFile("%kernel.project_dir%/public/codeqr/$Ntable.png");
                    $qrCode->setLogoSize(150, 200);
                    $qrCode->setValidateResult(false);
                 $tables->setCodeQr("$Ntable.png");
                    $tables->setRestaurant($restaurant);
