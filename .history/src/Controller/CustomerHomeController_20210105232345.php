...
{
    /**
     * @Route("/restaurant/{restaurant<[0-9]+>}/table/{table<[0-9]+>}/home", name="customer_home")
     */
    ...
    /**
     * @Route("/restaurant/{restaurant<[0-9]+>}/table/{table<[0-9]+>}/menu", name="customer_home_menu", methods={"GET,POST"})
     */
    public function menu(RestaurantsRepository $repo,Restaurants $restaurant,Tables $tables): Response
    {
        ...
        return $this->render('customer_home_menu/index.html.twig', [
