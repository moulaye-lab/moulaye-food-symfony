...

{
     ...
     */
    public function editPlat(EntityManagerInterface $em,ImagesRestoRepository $repo1,  Request $request,PlatMenu $plats, Restaurants $restaurant, PlatMenuRepository $repo, CategoriesMenu $categorie,CategoriesMenuRepository $categorieMenu): Response
    {
