...
{
    /**
     * @Route("/restaurant/{restaurants<[0-9]+>}/table/{tables<[0-9]+>}", name="customer_home")
     */
    public function index(RestaurantsRepository $repo,Restaurants $restaurants,Tables $tables): Response
    {
            $resto=$repo->findByResto($restaurants);
