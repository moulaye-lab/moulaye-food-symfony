...
class CaisseController extends AbstractController
{
    ...
    public function index(Restaurants $restaurant,TablesRepository $table,CommandesRepository $repo): Response
    {
        ...
        foreach ($commandesByTable as $key => $value) {
            ...
            'commande' => $commandesByTable,
        ]);
    }


     /**
     * @Route("/caisse/{restaurant}/{table}/encaisser", name="app_caisse_encaisser")
     */
    public function encaisser(Restaurants $restaurant,CommandesRepository $repo , Tables $table): Response
    {
        $user=$this->getUser();
        ...
        $commandes=$repo->findByRestoAndTable($restaurant,$table);
