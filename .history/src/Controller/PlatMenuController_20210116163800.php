...

{
     ...
     * @Route("/plat/menu/restaurant/{restaurant}/categorie/{categorie}/edit", name="edit_plat_menu")
     */
    public function Plat(EntityManagerInterface $em,Request $request,PlatMenu $plats, Restaurants $restaurant, PlatMenuRepository $repo, CategoriesMenu $categorie,CategoriesMenuRepository $categorieMenu): Response
    {
