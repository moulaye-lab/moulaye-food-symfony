...
class CategoriesController extends AbstractController
{
    ...
    /**
     * @Route("/restaurant/{id<[0-9]+>}/create", name="app_create_restaurant", methods={"POST","GET"})
     */
    public function CreateCategories(Restaurants $restaurant,CategoriesMenu $categories,Request $request,EntityManagerInterface $em): Response
    {   
        ...
        if ($form->isSubmitted() && $form->isValid()) { 
            $categories->setIdUser($this->getUser()->getId());
