...
class CategoriesController extends AbstractController
{
    ...
    {   
      ...
      /**
     * @Route("/categories/{categorie}/edit", name="app_edit_categorie", methods={"POST","GET"})
     */
    public function EditCategories(CategoriesMenu $categories, Request $request,EntityManagerInterface $em): Response
    {   
