...
class CustomerHomeController extends AbstractController
{
    ...
    public function platsMenu( Restaurants $restaurant, PlatMenuRepository $repo, CategoriesMenu $categorie,CategoriesMenuRepository $categorieMenu): Response
    {
      ...
      /**
     * @Route("/plat/menu/restaurant/{restaurant}/categorie/{categorie}", name="'app_infoRestaurant_customer'")
     */
    public function RestaurantInfo( Restaurants $restaurant,RestaurantsRepository $repo): Response
    {

       
        return $this->render('customer_home/restaurantInfo.html.twig', [
