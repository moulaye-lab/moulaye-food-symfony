...
class CartController extends AbstractController
{
    ...
    public function Commander( Request $request,EntityManagerInterface $em,PlatMenuRepository $plat): Response
    {
        ...
        foreach($panierData as $item){
            ...
            $commande->setTablesId($session->get('table')->getNumero());

            $commande->setRestaurant($restaurant);

            $commande->setTableResto($session->get('table')->getNumero());
        ...
        $this->addFlash('success','Votre commande à bien étée passer.Vous serez servi très rapidement');
