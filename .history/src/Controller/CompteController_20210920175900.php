...
class CompteController extends AbstractController
{
     ...
     */
    public function index(User $user,RestaurantsRepository $repoResto,UserPasswordEncoderInterface $passwordEncoder,Request $request,EntityManagerInterface $em): Response
    {
