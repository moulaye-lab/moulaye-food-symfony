...

{
     ...
     */
    public function editPlat(EntityManagerInterface $em,ImagesRestoRepository $em1,  Request $request,PlatMenu $plats, Restaurants $restaurant, PlatMenuRepository $repo, CategoriesMenu $categorie,CategoriesMenuRepository $categorieMenu): Response
    {
