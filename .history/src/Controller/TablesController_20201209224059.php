...
/**
     * @Route("/tables/{id<[0-9]+>}/edit", name="app_edit_restaurant", methods={"POST","GET"})
     */
    public function ediTables(Restaurants $restaurant,Request $request,EntityManagerInterface $em): Response
    {   
