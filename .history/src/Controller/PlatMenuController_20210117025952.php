...

{
     ...
     */
    public function editPlat(EntityManagerInterface $em,ImagesRestoRepository $repo,  Request $request,PlatMenu $plats, Restaurants $restaurant, PlatMenuRepository $repo, CategoriesMenu $categorie,CategoriesMenuRepository $categorieMenu): Response
    {
